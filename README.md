...
Sven Yrvind first met Paradox in Florida in 1997, when he visited Matt Layden on the Indian River near Stuart. He stayed with Matt and Karen, sailed the boat, and studied its choices at close range. What struck him was how deliberately it was built for thin water. The boxy midsection, the flat bottom, and the low rig fit the protected sounds and shoal bays that run down the U.S. East Coast and out into the Bahamas. In that world a boat that can slide across banks, sit upright on a flat, and anchor in inches of water opens miles that deeper boats skip.
...
Since Matt Layden first drew Paradox, most builders have stayed close to the plans. A few projects, however, pushed the idea in new directions while keeping the core brief: small size, efficiency, and self-sufficiency.

One early outlier was Ironsides, built by Stephen Yahn. To open the middle of the boat, Yahn narrowed the plywood web at bulkhead 3 to about 1½ inches (38 mm) and reinforced it with steel weldments, encapsulated in epoxy and fastened with hot-dipped galvanized bolts. He also considered soft “cloth bins” rather than plywood lockers to keep the passage open. A “Floorplan D” sketch in the group files shows the clear floor area he was aiming for. Ironsides launched on October 15, 2008; Yahn reported running about 395 lb (179 kg) of ballast on the first sail and noted long hands-off stretches on the helm.

Another distinctive experiment was “ParaPlastic,” Kjell Karlsson’s all-composite build. He replaced plywood with Divinycell foam core, glassed inside with epoxy and skinned outside with polyester cloth in epoxy. His listed thicknesses were 30 mm in the sides and deck, 50 mm in the bottom, and 15 mm in bulkheads (with thinner panels elsewhere). Karlsson emphasized that the foam core provided enough insulation that no separate lining was needed, and his updates show the boat being painted and finished much like a conventional hull.

Scaling the concept, Eerik Mee in Estonia built a Paradox enlarged by 20 percent and rigged it as a junk. To keep balance with the new sail plan, he moved the mast forward to just ahead of the bulkhead and shifted the chine runners forward as well, choosing a vertical-leech junk to keep the center of effort as far aft as practical. Early notes after launching describe successful tacks and promising behavior with further tuning planned.
