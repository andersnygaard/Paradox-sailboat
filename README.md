...
Matt Layden picked up the concept of utilizing what aerodynamic engineers might refer to as a "fence" from Phil Bolger's designs, which included the use of external chine battens on some of his sharpie boats. This idea influenced Layden's development of chine runners. The purpose of the "fence" is to separate areas of high and low pressure, minimizing the flow across the chine. This concept evolved into Layden’s distinctive chine runners.

The system relies on what is known in aerodynamics as a "lifting body," a concept that Matt came across in articles about experimental NASA planes from the 1970s. In the context of his sailboats, the lifting body hull is designed to work with the chine runners to reduce leeway by generating lift, similar to how a wing functions. The chine runners aid in this process by acting like a "fence" to help separate the high and low-pressure areas along the hull, contributing to the overall leeway resistance. When a boat with chine runners sails, the water flow along the chine creates a lifting force. This force is similar to the aerodynamic lift experienced by an airplane wing, albeit in a hydrodynamic context.

Traditional designs used deeper underwater structures to counteract this force. Chine runners, on the other hand, achieve this by creating a hydrodynamic lift, working in conjunction with the boat's hull and rudder.
